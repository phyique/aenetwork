...
const options = { secretOrKey: 'TOP_SECRET', jwtFromRequest: ExtractJWT.fromAuthHeaderAsBearerToken('authorization') };
passport.use(new JWTstrategy(options, async (token, cd) => {
  try {
